    ...
    public partial class BasicEditor : DockContent, IEditor, IFindReplaceProvider, INavigatableDocument
    {
        ...
        public int CursorColumn
        {
            ...
            set
            {
                ...
                txtEdit.Caret.SetPos(new Alsing.SourceCode.TextPoint(value, txtEdit.Caret.Position.X));
            }
        }
        ...
        public bool SetCursorByLocation(int line, int column)
        {
            ...
            txtEdit.Caret.SetPos(new Alsing.SourceCode.TextPoint(column, line));
        ...
        public bool SetCursorByOffset(int offset)
        {
            if (offset >= 0)
            {
                txtEdit.Caret.SetPos(new Alsing.SourceCode.TextPoint(txtEdit.Caret.Position.Y, offset));
