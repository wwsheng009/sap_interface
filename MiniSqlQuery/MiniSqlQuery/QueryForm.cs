...
namespace MiniSqlQuery
{
    ...
    public partial class QueryForm : DockContent, IQueryEditor, IPrintableContent
    {
        ...
        {
            get { return txtQuery.Document.Text; }
            set { txtQuery.Document.Text = value; }
        }
        ...
        public int CursorColumn
        {
            get
            {
                ...
                return txtQuery.Caret.Position.Y;

            }
            set
            {
                // txtQuery.ActiveTextAreaControl.Caret.Column = value; 
                txtQuery.Caret.SetPos(new Alsing.SourceCode.TextPoint(txtQuery.Caret.Position.X, value));
            }
        }
        ...
        public int CursorLine
        {
            get
            {
                ...
                return txtQuery.Caret.Position.X;
            }
            set
            {
                txtQuery.Caret.SetPos(new Alsing.SourceCode.TextPoint(value, txtQuery.Caret.Position.Y));
        ...
        public string SelectedText
        {
            get
            {
                return txtQuery.Selection.Text;
        ...
        public int TotalLines
        {
            get
            {
                ...
                return txtQuery.Document.Lines.GetLength(0);
            }
        }
        ...
        public void ClearSelection()
        {
            ...
            txtQuery.Selection.ClearSelection();
        }
        ...
        public void HighlightString(int offset, int length)
        {
            ...
            txtQuery.Selection.SelStart = offset;
            txtQuery.Selection.SelLength = length;
            txtQuery.Selection.SelEnd = endPos;
        ...
        public void InsertText(string text)
        {
            ...
            int offset = txtQuery.Caret.Position.X;
            ...
            txtQuery.Selection.ClearSelection();
            txtQuery.Document.InsertText(text, offset, txtQuery.Caret.Position.Y);
            // txtEdit.Document.Insert(offset, text);
            int newOffset = offset + text.Length; 
            // new offset at end of inserted text
        ...
        public void SetSyntax(string name)
        {
            ...
            this.txtQuery.Document.Parser.Init(sl);
        }
        ...
        public bool SetCursorByLocation(int line, int column)
        {
            ...
            //txtQuery.Caret.SetPos(new Alsing.SourceCode.TextPoint(line, column));
            txtQuery.Caret.Position.Y = line;
        ...
        public bool SetCursorByOffset(int offset)
        {
            if (offset >= 0)
            {
                txtQuery.Caret.SetPos(new Alsing.SourceCode.TextPoint(offset, txtQuery.Caret.Position.Y));
                // txtQuery.ActiveTextAreaControl.Caret.Position = txtEdit.Document.OffsetToPosition(offset);
                return true;
            }
