...
namespace ExcelAddIn1
{
    public partial class SAPQueryControl : UserControl
    {
        ...
        {
            InitializeComponent();
            cbxSystemList.DataSource = ConfigFileTool.SAPGlobalSettings.GetSAPClientList();
            cbxSystemList.Text = ConfigFileTool.SAPGlobalSettings.GetDefaultSapCient();
        }
