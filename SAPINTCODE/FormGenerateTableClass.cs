...
namespace SAPINTCODE
{
    ...
    public partial class FormGenerateTableClass : Form
    {
        ...
        public FormGenerateTableClass()
        {
            ...
            this.cbxSystemList.DataSource = SAPINT.SAPConfigList.SystemNameList;
            this.textBoxTemplate.Text = 
@"public class $rfctable.Name
{
#foreach($row in $rfctable.Rows)
	public $row.DOTNETTYPE $row.FIELDNAME {get;set;} // $row.FIELDTEXT
#end
}";
        ...
        {
           // CDataGridViewUtils.SelectRows(dgvFieldList);
        }

        private void btnCancle_Click(object sender, EventArgs e)
        {
          //  CDataGridViewUtils.UnSelectRows(dgvFieldList);
        }
    }
