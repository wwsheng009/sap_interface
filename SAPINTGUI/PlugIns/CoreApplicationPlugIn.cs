...
namespace SAPINT.Gui.PlugIns
{
	...
	public class CoreApplicationPlugIn : PluginLoaderBase
	{
		...
		public override void InitializePlugIn()
		{
            ...
            services.RegisterComponent<NewFileForm>();
            services.RegisterComponent<OptionsForm>();
            services.RegisterComponent<IMostRecentFilesService, MostRecentFilesService>();
