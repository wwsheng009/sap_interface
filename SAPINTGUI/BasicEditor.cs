...
namespace SAPINT.Gui
{
    ...
    public partial class BasicEditor : DockContent, IEditor, IFindReplaceProvider, INavigatableDocument
    {
        ...
        public BasicEditor()
        {
            ...
            txtEdit.Document.Change += Document_Change;
        }
        ...
        {
            get { return txtEdit.Document.Text; }
            set { txtEdit.Document.Text = value; }
        }
        ...
        public int CursorColumn
        {
            get
            {
                //return txtEdit.ActiveTextAreaControl.Caret.Column;
                return txtEdit.Caret.Position.X;

            }
            set
            {
                // txtEdit.ActiveTextAreaControl.Caret.Column = value; 
                txtEdit.Caret.SetPos(new Alsing.SourceCode.TextPoint(txtEdit.Caret.Position.X, value));
            }
        }
        ...
        public int CursorLine
        {
            get
            {
                // return txtEdit.ActiveTextAreaControl.Caret.Line;
                return txtEdit.Caret.Position.Y;
            }
            set
            {
                txtEdit.Caret.SetPos(new Alsing.SourceCode.TextPoint(value, txtEdit.Caret.Position.Y));
                //txtEdit.ActiveTextAreaControl.Caret.Line = value; 
            }
        }
        ...
        public int CursorOffset
        {
            get
            {
                //  return txtEdit.ActiveTextAreaControl.Caret.Offset;
                return txtEdit.Caret.Position.X;
               // return 0;
            }
        }
        ...
        public string SelectedText
        {
            get
            {
                return txtEdit.Selection.Text;
                //return txtEdit.ActiveTextAreaControl.SelectionManager.SelectedText; 
            }
        }
        ...
        public int TotalLines
        {
            get
            {
                //return txtEdit.Document.TotalNumberOfLines;
                return txtEdit.Document.Lines.GetLength(0);
            }
        }
        ...
        public void ClearSelection()
        {
            ...
            txtEdit.Selection.ClearSelection();
        }
        ...
        public void HighlightString(int offset, int length)
        {
            ...
            txtEdit.Selection.SelStart = offset;
            txtEdit.Selection.SelLength = length;
            txtEdit.Selection.SelEnd = endPos;
        ...
        public void InsertText(string text)
        {
            ...
            int offset = txtEdit.Caret.Position.X;
            ...
            //}
            txtEdit.Selection.ClearSelection();
            txtEdit.Document.InsertText(text, offset, txtEdit.Caret.Position.Y);
        ...
        public bool SetCursorByLocation(int line, int column)
        {
            ...
            txtEdit.Caret.SetPos(new Alsing.SourceCode.TextPoint(line,column));
        ...
        public bool SetCursorByOffset(int offset)
        {
            if (offset >= 0)
            {
                txtEdit.Caret.SetPos(new Alsing.SourceCode.TextPoint(offset,txtEdit.Caret.Position.Y));
